...
<?php require(DIR_FS_CATALOG . DIR_WS_INCLUDES . 'form_check.js.php'); ?>

<h1><?php echo HEADING_TITLE_SHIPPING_ADDRESS; ?></h1>
...
?>
  ...
  <?php require(DIR_FS_CATALOG . DIR_WS_MODULES . 'checkout_new_address.php'); ?>
...
?>
  ...
  <div class="contentText">
    <?php echo osc_draw_button(IMAGE_BUTTON_BACK, 'arrow-left', osc_href_link('checkout', 'shipping&address', 'SSL')); ?>
  </div>
