...
// display random review box
        ...
        $reviews_box_contents .= '<div class="ui-widget-content infoBoxContents"><div class="span4 pagination-centered"><a href="' . osc_href_link('products', 'reviews=' . $random_product['reviews_id'] . '&id=' . $random_product['products_id']) . '">' . osc_image(DIR_WS_IMAGES . $random_product['products_image'], $random_product['products_name'], SMALL_IMAGE_WIDTH, SMALL_IMAGE_HEIGHT) . '</a></div><div><a href="' . osc_href_link('products', 'reviews=' . $random_product['reviews_id'] . '&id=' . $random_product['products_id']) . '">' . $rand_review_text . ' ..</a></div><div class="pagination-centered">' . osc_image(DIR_WS_IMAGES . 'stars_' . $random_product['reviews_rating'] . '.gif' , sprintf(MODULE_BOXES_REVIEWS_BOX_TEXT_OF_5_STARS, $random_product['reviews_rating'])) . '</div></div>';
...
// display 'write a review' box
        $reviews_box_contents .= '<div class="ui-widget-content infoBoxContents"><div><div class="span4"><a href="' . osc_href_link('products', 'reviews&new&id=' . $_GET['id']) . '">' . osc_image(DIR_WS_IMAGES . 'box_write_review.gif', IMAGE_BUTTON_WRITE_REVIEW) . '</a></div><div><a href="' . osc_href_link('products', 'reviews&new&id=' . $_GET['id']) . '">' . MODULE_BOXES_REVIEWS_BOX_WRITE_REVIEW .'</a></div></div></div>';
      } else {
