...
*/
  ...
  class sb_twitter_button {
    ...
    function getOutput() {
      ...
      return '<script src="http://platform.twitter.com/widgets.js"></script><a href="http://twitter.com/share?' . $params . '" target="_blank" class="twitter-share-button">' . osc_output_string_protected($this->public_title) . '</a>';
    }
