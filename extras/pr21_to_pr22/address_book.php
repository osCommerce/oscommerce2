<?php
/*
  $Id: address_book.php,v 1.1 2003/05/19 21:58:46 hpdl Exp $
...
<p>This script updates the address book table so that the address_book_id field becomes auto_increment again.
...
<?php
  ...
  tep_db_query("alter table address_book change address_book_id address_book_id int not null auto_increment");
?>
