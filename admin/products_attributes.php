...
?>
                  ...
                  <tr>
                    <td align="right" colspan="3" class="smallText"><br /><?php echo osc_draw_button(IMAGE_BACK, 'triangle-1-w', osc_href_link(FILENAME_PRODUCTS_ATTRIBUTES, $page_info, 'NONSSL')); ?>&nbsp;</td>
                  </tr>
<?php
    } else {
?>
                  ...
                  <tr>
                    <td class="smallText" align="right" colspan="3"><br /><?php echo osc_draw_button(IMAGE_DELETE, 'trash', osc_href_link(FILENAME_PRODUCTS_ATTRIBUTES, 'action=delete_option&option_id=' . $_GET['option_id'] . '&' . $page_info, 'NONSSL'), 'primary') . osc_draw_button(IMAGE_CANCEL, 'close', osc_href_link(FILENAME_PRODUCTS_ATTRIBUTES, $page_info, 'NONSSL')); ?>&nbsp;</td>
                  </tr>
<?php
    }
?>
...
?>
                ...
                <td align="center" class="smallText">&nbsp;<?php echo osc_draw_button(IMAGE_SAVE, 'disk', null, 'primary') . osc_draw_button(IMAGE_CANCEL, 'close', osc_href_link(FILENAME_PRODUCTS_ATTRIBUTES, $page_info, 'NONSSL')); ?>&nbsp;</td>
<?php
        echo '</form>' . "\n";
      } else {
?>
...
?>
              <tr class="<?php echo (floor($rows/2) == ($rows/2) ? 'attributes-even' : 'attributes-odd'); ?>">
<?php
      echo '<form name="options" action="' . osc_href_link(FILENAME_PRODUCTS_ATTRIBUTES, 'action=add_product_options&' . $page_info, 'NONSSL') . '" method="post"><input type="hidden" name="products_options_id" value="' . $next_id . '">';
      $inputs = '';
      for ($i = 0, $n = sizeof($languages); $i < $n; $i ++) {
...
?>
                  ...
                  <tr>
                    <td class="smallText" align="right" colspan="3"><br /><?php echo osc_draw_button(IMAGE_BACK, 'triangle-1-w', osc_href_link(FILENAME_PRODUCTS_ATTRIBUTES, $page_info, 'NONSSL')); ?>&nbsp;</td>
                  </tr>
<?php
    } else {
?>
                  ...
                  <tr>
                    <td class="smallText" align="right" colspan="3"><br /><?php echo osc_draw_button(IMAGE_DELETE, 'trash', osc_href_link(FILENAME_PRODUCTS_ATTRIBUTES, 'action=delete_value&value_id=' . $_GET['value_id'] . '&' . $page_info, 'NONSSL'), 'primary') . osc_draw_button(IMAGE_CANCEL, 'close', osc_href_link(FILENAME_PRODUCTS_ATTRIBUTES, $page_info, 'NONSSL')); ?>&nbsp;</td>
                  </tr>
<?php
    }
?>
...
?>
                ...
                <td align="center" class="smallText">&nbsp;<?php echo osc_draw_button(IMAGE_EDIT, 'document', osc_href_link(FILENAME_PRODUCTS_ATTRIBUTES, 'action=update_option_value&value_id=' . $values_values['products_options_values_id'] . '&' . $page_info, 'NONSSL')) . osc_draw_button(IMAGE_DELETE, 'trash', osc_href_link(FILENAME_PRODUCTS_ATTRIBUTES, 'action=delete_option_value&value_id=' . $values_values['products_options_values_id'] . '&' . $page_info, 'NONSSL')); ?>&nbsp;</td>
<?php
      }
...
?>
            ...
            <td align="center" class="smallText">&nbsp;<?php echo osc_draw_button(IMAGE_DELETE, 'trash', osc_href_link(FILENAME_PRODUCTS_ATTRIBUTES, 'action=delete_attribute&attribute_id=' . $_GET['attribute_id'] . '&' . $page_info), 'primary') . osc_draw_button(IMAGE_CANCEL, 'close', osc_href_link(FILENAME_PRODUCTS_ATTRIBUTES, $page_info, 'NONSSL')); ?>&nbsp;</td>
<?php
    } else {
?>
