...
<?php
  ...
  switch ($action) {
    case 'new':
      ...
      $languages = osc_get_languages();
      for ($i=0, $n=sizeof($languages); $i<$n; $i++) {
        $orders_status_inputs_string .= '<br />' . osc_image(DIR_WS_CATALOG_LANGUAGES . $languages[$i]['directory'] . '/images/' . $languages[$i]['image'], $languages[$i]['name']) . '&nbsp;' . osc_draw_input_field('orders_status_name[' . $languages[$i]['id'] . ']');
      }
    ...
    case 'edit':
      ...
      $languages = osc_get_languages();
      for ($i=0, $n=sizeof($languages); $i<$n; $i++) {
        $orders_status_inputs_string .= '<br />' . osc_image(DIR_WS_CATALOG_LANGUAGES . $languages[$i]['directory'] . '/images/' . $languages[$i]['image'], $languages[$i]['name']) . '&nbsp;' . osc_draw_input_field('orders_status_name[' . $languages[$i]['id'] . ']', osc_get_orders_status_name($oInfo->orders_status_id, $languages[$i]['id']));
      }
    ...
    default:
      if (isset($oInfo) && is_object($oInfo)) {
        ...
        $languages = osc_get_languages();
        for ($i = 0, $n = sizeof($languages); $i < $n; $i++) {
          $orders_status_inputs_string .= '<br />' . osc_image(DIR_WS_CATALOG_LANGUAGES . $languages[$i]['directory'] . '/images/' . $languages[$i]['image'], $languages[$i]['name']) . '&nbsp;' . osc_get_orders_status_name($oInfo->orders_status_id, $languages[$i]['id']);
        }
