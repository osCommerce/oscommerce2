...
// Check that order_id, customer_id and filename match
  ...
  if (!osc_db_num_rows($downloads_query)) die;
  $downloads = osc_db_fetch_array($downloads_query);
...
// Now decrement counter
  osc_db_query("update " . TABLE_ORDERS_PRODUCTS_DOWNLOAD . " set download_count = download_count-1 where orders_products_download_id = '" . (int)$_GET['id'] . "'");
