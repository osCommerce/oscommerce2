...
// create additional orders_status records
        ...
        while ($orders_status = tep_db_fetch_array($orders_status_query)) {
          tep_db_query("insert into " . TABLE_ORDERS_STATUS . " (orders_status_id, language_id, orders_status_name, public_flag, downloads_flag) values ('" . (int)$orders_status['orders_status_id'] . "', '" . (int)$insert_id . "', '" . tep_db_input($orders_status['orders_status_name']) . "', '" . tep_db_input($orders_status['public_flag']) . "', '" . tep_db_input($orders_status['downloads_flag']) . "')");
        }
