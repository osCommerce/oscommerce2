...
<table border="0" width="100%" cellspacing="0" cellpadding="0">
  ...
  <tr class="headerBar">
    ...
    <td class="headerBarContent" align="right"><?php echo (tep_session_is_registered('admin') ? ''. HEADER_TITLE_LOGIN . ' ' . $admin['username']  . ' (<a href="' . tep_href_link(FILENAME_LOGIN, 'action=logoff') . '" class="headerLink">'. HEADER_TITLE_LOGOUT .'</a>)' : ''); ?>&nbsp;&nbsp;</td>
  </tr>
</table>