...
define('TEXT_INFO_RESTORE', 'Do not interrupt the restoration process.<br /><br />The larger the backup, the longer this process takes!<br /><br />If possible, use the mysql client.<br /><br />For example:<br /><br /><strong>mysql -h' . OSCOM::getConfig('db_server') . ' -u' . OSCOM::getConfig('db_server_username') . ' -p ' . OSCOM::getConfig('db_database') . ' < %s </strong> %s');
