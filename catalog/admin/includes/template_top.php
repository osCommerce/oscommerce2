...
<base href="<?php echo (defined('ENABLE_SSL') && ENABLE_SSL == true) ? HTTPS_SERVER . DIR_WS_HTTPS_ADMIN : HTTP_SERVER . DIR_WS_ADMIN; ?>" />
...
<script type="text/javascript" src="<?php echo tep_catalog_href_link('ext/jquery/jquery-1.11.0.min.js', '', 'SSL'); ?>"></script>
