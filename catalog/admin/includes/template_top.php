...
<link rel="stylesheet" href="<?php echo tep_catalog_href_link('ext/jquery/ui/redmond/jquery-ui-1.8.18.css'); ?>">
<script src="<?php echo tep_catalog_href_link('ext/jquery/jquery-1.7.2.min.js'); ?>"></script>
<script src="<?php echo tep_catalog_href_link('ext/jquery/ui/jquery-ui-1.8.18.min.js'); ?>"></script>
