  ...
  if (osc_not_null($action)) {
    switch ($action) {
      case 'save':
        ...
        if ($error == false) {
          osc_redirect(osc_href_link(FILENAME_STORE_LOGO));
        }
        break;
    }
  }
...
?>
    ...
    <table border="0" width="100%" cellspacing="0" cellpadding="2">
      ...
      <tr>
        <td><?php echo osc_image(HTTP_CATALOG_SERVER . DIR_WS_CATALOG_IMAGES . 'store_logo.png'); ?></td>
      </tr>
      <tr>
        <td><?php echo osc_draw_separator('pixel_trans.gif', '1', '10'); ?></td>
      </tr>
      <tr>
        <td><?php echo osc_draw_form('logo', FILENAME_STORE_LOGO, 'action=save', 'post', 'enctype="multipart/form-data"'); ?>
