      ...
      <tr>
        <td><table border="0" width="100%" cellspacing="0" cellpadding="2">
          <tr>
            ...
            <td class="smallText" align="right" valign="top" nowrap><?php echo tep_draw_button(IMAGE_SAVE, 'disk', null, 'primary') . tep_draw_button(IMAGE_CANCEL, 'close', tep_href_link(FILENAME_BANNER_MANAGER, (isset($_GET['page']) ? 'page=' . $_GET['page'] . '&' : '') . (isset($_GET['bID']) ? 'bID=' . $_GET['bID'] : ''))); ?></td>
          </tr>
        </table></td>
      </form></tr>
<?php
...
?>
                <td class="dataTableContent"><?php echo '<a onclick="event.stopPropagation();" href="' . HTTP_CATALOG_SERVER . DIR_WS_CATALOG_IMAGES . $banners['banners_image'] . '" target="_blank">' . tep_image(DIR_WS_IMAGES . 'icon_popup.gif', TEXT_VIEW_BANNER) . '</a> ' . $banners['banners_title']; ?></td>
