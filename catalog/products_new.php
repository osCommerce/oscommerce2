...
?>
          <tr>
            ...
            <td align="right" valign="middle" class="main"><?php echo tep_draw_button(array('href' => tep_href_link(FILENAME_PRODUCTS_NEW, tep_get_all_get_params(array('action')) . 'action=buy_now&products_id=' . $products_new['products_id']), 'title' => IMAGE_BUTTON_IN_CART, 'icon' => 'cart', 'priority' => 'secondary')); ?></td>
          </tr>
          <tr>
