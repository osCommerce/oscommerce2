...
*/
  ...
  $test = $OSCOM_Braintree->makeApiCall('https://tlstest.paypal.com', null, null, array('returnFull' => true, 'sslVersion' => 0));

  $result['default'] = (isset($test['info']['http_code']) && ((int)$test['info']['http_code'] === 200));

  $test = $OSCOM_Braintree->makeApiCall('https://tlstest.paypal.com', null, null, array('returnFull' => true, 'sslVersion' => 6));
