...
cfg_ssl_version_desc = Use the default cURL configured SSL version connection setting when making API calls to Braintree's servers or force TLS v1.2 connections.
...
cfg_ssl_version_dialog_default_failed = A connection to Braintree could not be made using the default cURL configured SSL version.<br /><br />The SSL Version parameter must be set to TLS v1.2 by <b>June 30, 2017</b> otherwise connections will continue to fail.
cfg_ssl_version_dialog_tlsv12_failed = A connection to Braintree could not be made using TLS v1.2. Please consult with your hosting provider to upgrade the cURL version that is installed with your PHP web server to support TLS v1.2 connections.<br /><br />This must be performed by <b>June 30, 2017</b> otherwise connections will continue to fail.
