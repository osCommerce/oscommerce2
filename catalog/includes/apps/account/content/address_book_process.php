...
<?php echo tep_draw_form('addressbook', tep_href_link('account', 'address_book&process' . (isset($_GET['id']) ? '&id=' . $_GET['id'] : ''), 'SSL'), 'post', 'onsubmit="return check_form(addressbook);"', true); ?>
...
?>
  ...
  <div>
    <span style="float: right;"><?php echo tep_draw_button(IMAGE_BUTTON_UPDATE, 'refresh', null, 'primary'); ?></span>
...
<?php
    ...
    if ( sizeof($_SESSION['navigation']->snapshot) > 0 ) {
      ...
      $back_link = tep_href_link('account', 'address_book', 'SSL');
    }
?>
