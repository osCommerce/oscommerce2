...
// Display a list
          ...
          while ($manufacturers = tep_db_fetch_array($manufacturers_query)) {
            ...
            $manufacturers_list .= '<li><a href="' . tep_href_link(null, 'manufacturers_id=' . $manufacturers['manufacturers_id']) . '">' . $manufacturers_name . '</a></li>';
          }
...
// Display a drop-down
          ...
          $content = tep_draw_form('manufacturers', tep_href_link(null, '', 'NONSSL', false), 'get') .
