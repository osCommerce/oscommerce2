...
// Display a list
          ...
          while ($manufacturers = osc_db_fetch_array($manufacturers_query)) {
            ...
            $manufacturers_list .= '<li><a href="' . osc_href_link(FILENAME_DEFAULT, 'manufacturers_id=' . $manufacturers['manufacturers_id']) . '">' . $manufacturers_name . '</a></li>';
          }
...
// Display a drop-down
          ...
          $content = osc_draw_form('manufacturers', osc_href_link(FILENAME_DEFAULT, '', $request_type, false), 'get') .
