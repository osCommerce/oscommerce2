  ...
  class bm_search {
    ...
    function execute() {
      ...
      $data = '<div class="ui-widget infoBoxContainer">' .
              ...
              '    ' . tep_draw_form('quick_find', tep_href_link(), 'get') . tep_draw_hidden_field('search', '') .
              '    ' . tep_draw_input_field('q', '', 'size="10" maxlength="30" style="width: 75%"') . '&nbsp;' . tep_hide_session_id() . tep_image_submit('button_quick_find.gif', MODULE_BOXES_SEARCH_BOX_TITLE) . '<br />' . MODULE_BOXES_SEARCH_BOX_TEXT . '<br /><a href="' . tep_href_link('search') . '"><strong>' . MODULE_BOXES_SEARCH_BOX_ADVANCED_SEARCH . '</strong></a>' .
              '    </form>' .
              '  </div>' .
              '</div>';
