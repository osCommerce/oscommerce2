...
*/
  ...
  class ar_contact_us {
    ...
    function ar_contact_us() {
      ...
      if ($this->check()) {
        $this->min_minutes = (int)MODULE_ACTION_RECORDER_CONTACT_US_EMAIL_MINUTES;
        $this->log_retries = (MODULE_ACTION_RECORDER_CONTACT_US_LOG_RETRIES == 'True') ? true : false;
      }
    }
    ...
    function install() {
      ...
      tep_db_query("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) values ('Log Retries', 'MODULE_ACTION_RECORDER_CONTACT_US_LOG_RETRIES', 'False', 'Log failed retry attempts', '6', '0', 'tep_cfg_select_option(array(\'True\', \'False\'), ', now())");
    }
    ...
    function keys() {
      return array('MODULE_ACTION_RECORDER_CONTACT_US_EMAIL_MINUTES', 'MODULE_ACTION_RECORDER_CONTACT_US_LOG_RETRIES');
    }
  }
?>
