...
// class constructor
    function ipayment_pp() {
      ...
      $this->sort_order = ( defined('MODULE_PAYMENT_IPAYMENT_PP_SORT_ORDER') ? MODULE_PAYMENT_IPAYMENT_PP_SORT_ORDER : 0 );
      $this->enabled = ( (defined('MODULE_PAYMENT_IPAYMENT_PP_STATUS') && (MODULE_PAYMENT_IPAYMENT_PP_STATUS == 'True')) ? true : false );

      if (defined('MODULE_PAYMENT_IPAYMENT_PP_ORDER_STATUS_ID') && defined('MODULE_PAYMENT_IPAYMENT_PP_ID')) {
