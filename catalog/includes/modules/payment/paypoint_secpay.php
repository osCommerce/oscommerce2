...
// class constructor
    function paypoint_secpay() {
      ...
      $this->sort_order = ( defined('MODULE_PAYMENT_PAYPOINT_SECPAY_SORT_ORDER') ? MODULE_PAYMENT_PAYPOINT_SECPAY_SORT_ORDER : 0 );
      $this->enabled = ( (defined('MODULE_PAYMENT_PAYPOINT_SECPAY_STATUS') && (MODULE_PAYMENT_PAYPOINT_SECPAY_STATUS == 'True') ? true : false) );

      if ( defined('MODULE_PAYMENT_PAYPOINT_SECPAY_PREPARE_ORDER_STATUS_ID') && (int)MODULE_PAYMENT_PAYPOINT_SECPAY_PREPARE_ORDER_STATUS_ID > 0 ) {
