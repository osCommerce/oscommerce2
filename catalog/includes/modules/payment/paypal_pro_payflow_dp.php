...
// class constructor
    function paypal_pro_payflow_dp() {
      ...
      $this->sort_order = ( defined('MODULE_PAYPAL_PRO_PAYFLOW_DP_SORT_ORDER') ? MODULE_PAYPAL_PRO_PAYFLOW_DP_SORT_ORDER : 0 );
      $this->enabled = ( (defined('MODULE_PAYPAL_PRO_PAYFLOW_DP_STATUS') && (MODULE_PAYPAL_PRO_PAYFLOW_DP_STATUS == 'True') ? true : false) );

      if ( defined('MODULE_PAYPAL_PRO_PAYFLOW_DP_PREPARE_ORDER_STATUS_ID') && (int)MODULE_PAYPAL_PRO_PAYFLOW_DP_PREPARE_ORDER_STATUS_ID > 0 ) {
