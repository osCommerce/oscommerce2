...
// class methods
    ...
    function checkout_initialization_method() {
      ...
      $string = '<a href="' . osc_href_link('ext/modules/payment/paypal/express_payflow.php', '', 'SSL') . '"><img src="' . $image . '" border="0" alt="" title="' . osc_output_string_protected(MODULE_PAYMENT_PAYPAL_PRO_PAYFLOW_EC_TEXT_BUTTON) . '" /></a>';
    ...
    function install() {
      ...
      osc_db_query("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) values ('Transaction Server', 'MODULE_PAYMENT_PAYPAL_PRO_PAYFLOW_EC_TRANSACTION_SERVER', 'Live', 'Use the live or testing (sandbox) gateway server to process transactions?', '6', '0', 'osc_cfg_select_option(array(\'Live\', \'Sandbox\'), ', now())");
