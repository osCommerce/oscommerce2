...
// class constructor
    function moneybookers() {
      ...
      $this->sort_order = ( defined('MODULE_PAYMENT_MONEYBOOKERS_SORT_ORDER') ? MODULE_PAYMENT_MONEYBOOKERS_SORT_ORDER : 0 );
      $this->enabled = ( (defined('MODULE_PAYMENT_MONEYBOOKERS_STATUS') && (MODULE_PAYMENT_MONEYBOOKERS_STATUS == 'True') ? true : false) );

      if ( defined('MODULE_PAYMENT_MONEYBOOKERS_PREPARE_ORDER_STATUS_ID') && (int)MODULE_PAYMENT_MONEYBOOKERS_PREPARE_ORDER_STATUS_ID > 0 ) {
