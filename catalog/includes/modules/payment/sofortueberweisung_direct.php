...
// class constructor
    function sofortueberweisung_direct() {
      ...
      $this->sort_order = ( defined('MODULE_SOFORTUEBERWEISUNG_DIRECT_SORT_ORDER') ? MODULE_SOFORTUEBERWEISUNG_DIRECT_SORT_ORDER : 0 );
      $this->enabled = ( (defined('MODULE_SOFORTUEBERWEISUNG_DIRECT_STATUS') && (MODULE_SOFORTUEBERWEISUNG_DIRECT_STATUS == 'True') ? true : false) );

      if ( defined('MODULE_SOFORTUEBERWEISUNG_DIRECT_PREPARE_ORDER_STATUS_ID') && (int)MODULE_SOFORTUEBERWEISUNG_DIRECT_PREPARE_ORDER_STATUS_ID > 0 ) {
