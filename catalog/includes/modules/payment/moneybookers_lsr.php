...
// class constructor
    function moneybookers_lsr() {
      ...
      $this->sort_order = ( defined('MODULE_PAYMENT_MONEYBOOKERS_LSR_SORT_ORDER') ? MODULE_PAYMENT_MONEYBOOKERS_LSR_SORT_ORDER : 0 );
      $this->enabled = ( (defined('MODULE_PAYMENT_MONEYBOOKERS_LSR_STATUS') && (MODULE_PAYMENT_MONEYBOOKERS_LSR_STATUS == 'True') ? true : false) );

      if ( defined('MODULE_PAYMENT_MONEYBOOKERS_LSR_PREPARE_ORDER_STATUS_ID') && (int)MODULE_PAYMENT_MONEYBOOKERS_LSR_PREPARE_ORDER_STATUS_ID > 0 ) {
