...
// class methods
    ...
    function process_button() {
      ...
      $process_button_string = tep_draw_hidden_field('MerchantID', MODULE_PAYMENT_PSIGATE_MERCHANT_ID) .
                               ...
                               tep_draw_hidden_field('ThanksURL', tep_href_link('checkout', 'process', 'SSL', true)) .
                               tep_draw_hidden_field('NoThanksURL', tep_href_link('checkout', 'payment&payment_error=' . $this->code, 'NONSSL', true)) .
