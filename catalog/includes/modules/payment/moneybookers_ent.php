...
// class constructor
    function moneybookers_ent() {
      ...
      $this->sort_order = ( defined('MODULE_PAYMENT_MONEYBOOKERS_ENT_SORT_ORDER') ? MODULE_PAYMENT_MONEYBOOKERS_ENT_SORT_ORDER : 0 );
      $this->enabled = ( (defined('MODULE_PAYMENT_MONEYBOOKERS_ENT_STATUS') && (MODULE_PAYMENT_MONEYBOOKERS_ENT_STATUS == 'True') ? true : false) );

      if ( defined('MODULE_PAYMENT_MONEYBOOKERS_ENT_PREPARE_ORDER_STATUS_ID') && (int)MODULE_PAYMENT_MONEYBOOKERS_ENT_PREPARE_ORDER_STATUS_ID > 0 ) {
