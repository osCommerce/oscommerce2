...
// class constructor
    function nochex() {
      ...
      $this->sort_order = ( defined('MODULE_PAYMENT_NOCHEX_SORT_ORDER') ? MODULE_PAYMENT_NOCHEX_SORT_ORDER : 0 );
      $this->enabled = ( (defined('MODULE_PAYMENT_NOCHEX_STATUS') && (MODULE_PAYMENT_NOCHEX_STATUS == 'True') ? true : false) );

      if ( defined('MODULE_PAYMENT_NOCHEX_PREPARE_ORDER_STATUS_ID') && (int)MODULE_PAYMENT_NOCHEX_PREPARE_ORDER_STATUS_ID > 0 ) {
