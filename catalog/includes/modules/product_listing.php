...
<?php
  $prod_list_contents = '<table border="0" width="100%" cellspacing="0" cellpadding="2" class="ui-widget-header ui-corner-top infoBoxHeading" style="table-layout: fixed;">' .
                        '  <tr>';
  ...
  if ($listing_split->number_of_rows > 0) {
    ...
    $prod_list_contents .= '<table border="0" width="100%" cellspacing="0" cellpadding="2" class="ui-widget-content ui-corner-bottom productListTable" style="table-layout: fixed;">';
        ...
        switch ($column_list[$col]) {
          ...
          case 'PRODUCT_LIST_PRICE':
            if (tep_not_null($listing['specials_new_products_price'])) {
              $prod_list_contents .= '    <td align="right">&nbsp;<s>' .  $currencies->display_price($listing['products_price'], tep_get_tax_rate($listing['products_tax_class_id'])) . '</s>&nbsp;&nbsp;<span class="productSpecialPrice">' . $currencies->display_price($listing['specials_new_products_price'], tep_get_tax_rate($listing['products_tax_class_id'])) . '</span>&nbsp;</td>';
            } else {
