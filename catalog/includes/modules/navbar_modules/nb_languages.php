  ...
  */
  ...
  class nb_languages {
    ...
    function __construct() {
      $this->title = OSCOM::getDef('module_navbar_languages_title');
      $this->description = OSCOM::getDef('module_navbar_languages_description');
    ...
    function install() {
      ...
      $OSCOM_Db->save('configuration', [
        ...
        'configuration_key' => 'MODULE_NAVBAR_LANGUAGES_STATUS',
      ...
      $OSCOM_Db->save('configuration', [
        ...
        'configuration_key' => 'MODULE_NAVBAR_LANGUAGES_CONTENT_PLACEMENT',
      ...
      $OSCOM_Db->save('configuration', [
        ...
        'configuration_key' => 'MODULE_NAVBAR_LANGUAGES_SORT_ORDER',
