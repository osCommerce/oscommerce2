  ...
  */
  ...
  class nb_reviews {
    ...
    function __construct() {
      $this->title = OSCOM::getDef('module_navbar_reviews_title');
      $this->description = OSCOM::getDef('module_navbar_reviews_description');
    ...
    function install() {
      ...
      $OSCOM_Db->save('configuration', [
        ...
        'configuration_key' => 'MODULE_NAVBAR_REVIEWS_STATUS',
      ...
      $OSCOM_Db->save('configuration', [
        ...
        'configuration_key' => 'MODULE_NAVBAR_REVIEWS_CONTENT_PLACEMENT',
      ...
      $OSCOM_Db->save('configuration', [
        ...
        'configuration_key' => 'MODULE_NAVBAR_REVIEWS_SORT_ORDER',
