  ...
  class nb_special_offers {
    ...
    function install() {
      ...
      $OSCOM_Db->save('configuration', [
        'configuration_title' => 'Enable Special Offers Module',
        'configuration_key' => 'MODULE_NAVBAR_SPECIAL_OFFERS_STATUS',
      ...
      $OSCOM_Db->save('configuration', [
        ...
        'configuration_key' => 'MODULE_NAVBAR_SPECIAL_OFFERS_CONTENT_PLACEMENT',
      ...
      $OSCOM_Db->save('configuration', [
        ...
        'configuration_key' => 'MODULE_NAVBAR_SPECIAL_OFFERS_SORT_ORDER',
