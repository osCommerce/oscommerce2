  ...
  */
  ...
  class nb_account {
    ...
    function __construct() {
      $this->title = OSCOM::getDef('module_navbar_account_title');
      $this->description = OSCOM::getDef('module_navbar_account_description');
    ...
    function install() {
      ...
      $OSCOM_Db->save('configuration', [
        'configuration_title' => 'Enable Account Module',
        'configuration_key' => 'MODULE_NAVBAR_ACCOUNT_STATUS',
      ...
      $OSCOM_Db->save('configuration', [
        ...
        'configuration_key' => 'MODULE_NAVBAR_ACCOUNT_CONTENT_PLACEMENT',
      ...
      $OSCOM_Db->save('configuration', [
        ...
        'configuration_key' => 'MODULE_NAVBAR_ACCOUNT_SORT_ORDER',
