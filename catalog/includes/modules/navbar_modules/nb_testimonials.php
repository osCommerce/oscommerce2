...
*/
  ...
  class nb_testimonials {
    ...
    function __construct() {
      $this->title = OSCOM::getDef('module_navbar_testimonials_title');
      $this->description = OSCOM::getDef('module_navbar_testimonials_description');
    ...
    function install() {
      ...
      $OSCOM_Db->save('configuration', [
        'configuration_title' => 'Enable Testimonials Module',
        'configuration_key' => 'MODULE_NAVBAR_TESTIMONIALS_STATUS',
      ...
      $OSCOM_Db->save('configuration', [
        ...
        'configuration_key' => 'MODULE_NAVBAR_TESTIMONIALS_CONTENT_PLACEMENT',
      ...
      $OSCOM_Db->save('configuration', [
        ...
        'configuration_key' => 'MODULE_NAVBAR_TESTIMONIALS_SORT_ORDER',
        'configuration_value' => '535',
