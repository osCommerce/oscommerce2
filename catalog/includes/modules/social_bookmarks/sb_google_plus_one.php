...
*/
  ...
  class sb_google_plus_one {
    ...
    function getOutput() {
      $output = '<div class="g-plusone" data-href="' . osc_href_link('products', 'id=' . $_GET['id'], 'NONSSL', false) . '" data-size="' . strtolower(MODULE_SOCIAL_BOOKMARKS_GOOGLE_PLUS_ONE_SIZE) . '" data-annotation="' . strtolower(MODULE_SOCIAL_BOOKMARKS_GOOGLE_PLUS_ONE_ANNOTATION) . '"';
