        ...
        <div class="caption">
          ...
          <div class="text-center">
            <div class="btn-group">
              ...
              <a href="<?php echo OSCOM::link($PHP_SELF, tep_get_all_get_params(array('action')) . 'action=buy_now&products_id=' . (int)$new_product['products_id']); ?>" class="btn btn-success" role="button"><?php echo MODULE_CONTENT_NEW_PRODUCTS_BUTTON_BUY; ?></a>
            </div>
          </div>
        </div>
      </div>
