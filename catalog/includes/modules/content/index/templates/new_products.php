        ...
        <div class="caption">
          ...
          <div class="text-center">
            <div class="btn-group">
              ...
              <a href="<?php echo OSCOM::link($PHP_SELF, tep_get_all_get_params(array('action')) . 'action=buy_now&products_id=' . (int)$new_product['products_id']); ?>" class="btn btn-success btn-index btn-buy" role="button"><?php echo OSCOM::getDef('module_content_new_products_button_buy'); ?></a>
            </div>
          </div>
        </div>
      </div>
