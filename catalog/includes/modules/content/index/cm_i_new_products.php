  ...
  */
  ...
  class cm_i_new_products {
    ...
    function __construct() {
      ...
      $this->title = OSCOM::getDef('module_content_new_products_title');
      $this->description = OSCOM::getDef('module_content_new_products_description');
    ...
    function execute() {
      global $oscTemplate, $new_products_category_id, $currencies, $PHP_SELF;
      ...
      $Qproducts->bindInt(':limit', MODULE_CONTENT_NEW_PRODUCTS_MAX_DISPLAY);

      if (isset($new_products_category_id) && ($new_products_category_id != '0')) {
        $Qproducts->bindInt(':parent_id', $new_products_category_id);
      }
    ...
    function install() {
      ...
      $OSCOM_Db->save('configuration', [
        ...
        'configuration_key' => 'MODULE_CONTENT_NEW_PRODUCTS_STATUS',
      ...
      $OSCOM_Db->save('configuration', [
        ...
        'configuration_key' => 'MODULE_CONTENT_NEW_PRODUCTS_CONTENT_WIDTH',
      ...
      $OSCOM_Db->save('configuration', [
        ...
        'configuration_key' => 'MODULE_CONTENT_NEW_PRODUCTS_MAX_DISPLAY',
      ...
      $OSCOM_Db->save('configuration', [
        ...
        'configuration_key' => 'MODULE_CONTENT_NEW_PRODUCTS_DISPLAY_EACH',
      ...
      $OSCOM_Db->save('configuration', [
        ...
        'configuration_key' => 'MODULE_CONTENT_NEW_PRODUCTS_SORT_ORDER',
