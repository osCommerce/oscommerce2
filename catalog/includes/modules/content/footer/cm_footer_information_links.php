  ...
  */
  ...
  class cm_footer_information_links {
    ...
    function __construct() {
      ...
      $this->title = OSCOM::getDef('module_content_footer_information_title');
      $this->description = OSCOM::getDef('module_content_footer_information_description');
    ...
    function install() {
      ...
      $OSCOM_Db->save('configuration', [
        'configuration_title' => 'Enable Information Links Footer Module',
        'configuration_key' => 'MODULE_CONTENT_FOOTER_INFORMATION_STATUS',
        'configuration_value' => 'True',
        'configuration_description' => 'Do you want to enable the Information Links content module?',
      ...
      $OSCOM_Db->save('configuration', [
        ...
        'configuration_key' => 'MODULE_CONTENT_FOOTER_INFORMATION_CONTENT_WIDTH',
      ...
      $OSCOM_Db->save('configuration', [
        ...
        'configuration_key' => 'MODULE_CONTENT_FOOTER_INFORMATION_SORT_ORDER',
