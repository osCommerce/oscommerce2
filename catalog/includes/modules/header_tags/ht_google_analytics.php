...
*/
  ...
  _gaq.push([\'_trackPageview\']);' . "\n";
        ...
        if ( (MODULE_HEADER_TAGS_GOOGLE_ANALYTICS_EC_TRACKING == 'True') && ($OSCOM_APP->getCode() == 'checkout') && ($OSCOM_APP->getCurrentAction() == 'success') && isset($_SESSION['customer_id']) ) {
          $order_query = tep_db_query("select orders_id, billing_city, billing_state, billing_country from " . TABLE_ORDERS . " where customers_id = '" . (int)$_SESSION['customer_id'] . "' order by date_purchased desc limit 1");
