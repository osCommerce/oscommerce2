...
*/
  ...
  class ht_opensearch {
    ...
    function execute() {
      ...
      $oscTemplate->addBlock('<link rel="search" type="application/opensearchdescription+xml" href="' . tep_href_link('search', 'opensearch', 'NONSSL', false) . '" title="' . tep_output_string(STORE_NAME) . '" />', $this->group);
    }
