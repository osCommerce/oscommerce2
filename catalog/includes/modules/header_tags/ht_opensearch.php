...
*/
  ...
  class ht_opensearch {
    ...
    function install() {
      ...
      tep_db_query("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('16x16 Icon', 'MODULE_HEADER_TAGS_OPENSEARCH_ICON', '', 'A 16x16 sized icon (must be in .ico format, eg favicon.ico). (optional)', '6', '0', now())");
      tep_db_query("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('64x64 Image', 'MODULE_HEADER_TAGS_OPENSEARCH_IMAGE', '', 'A 64x64 sized image (must be in .png format, eg logo.png). (optional)', '6', '0', now())");
    ...
    function keys() {
      return array('MODULE_HEADER_TAGS_OPENSEARCH_STATUS', 'MODULE_HEADER_TAGS_OPENSEARCH_SHORT_NAME', 'MODULE_HEADER_TAGS_OPENSEARCH_DESCRIPTION', 'MODULE_HEADER_TAGS_OPENSEARCH_CONTACT', 'MODULE_HEADER_TAGS_OPENSEARCH_TAGS', 'MODULE_HEADER_TAGS_OPENSEARCH_ATTRIBUTION', 'MODULE_HEADER_TAGS_OPENSEARCH_ADULT_CONTENT', 'MODULE_HEADER_TAGS_OPENSEARCH_ICON', 'MODULE_HEADER_TAGS_OPENSEARCH_IMAGE', 'MODULE_HEADER_TAGS_OPENSEARCH_SORT_ORDER');
    }
  }
?>
