  ...
  class category_tree {
    ...
    public function __construct() {
      ...
      if ( isset($_category_tree_data) ) {
        ...
        $categories_query = tep_db_query("select c.categories_id, c.parent_id, c.categories_image, cd.categories_name from categories c, categories_description cd where c.categories_id = cd.categories_id and cd.language_id = '" . (int)$languages_id. "' order by c.parent_id, c.sort_order, cd.categories_name" . COLLATE_CLAUSE);
