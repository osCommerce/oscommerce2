...
*/
  ...
  define('MODULE_PAYMENT_PAYPAL_UK_DIRECT_CARD_OWNER_FIRSTNAME', 'Nombre del Titular de la tarjeta:');
  define('MODULE_PAYMENT_PAYPAL_UK_DIRECT_CARD_OWNER_LASTNAME', 'Apellido del Titular de la tarjeta:');
