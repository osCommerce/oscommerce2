...
*/
  ...
  define('MODULE_PAYMENT_IPAYMENT_TEXT_DESCRIPTION', '<img src="images/icon_popup.gif" border="0">&nbsp;<a href="https://www.ipayment.de" target="_blank" style="text-decoration: underline; font-weight: bold;">Visita la web de iPayment</a>');
