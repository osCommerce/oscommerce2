...
*/
  ...
  define('MODULE_PAYMENT_WORLDPAY_JUNIOR_TEXT_DESCRIPTION', '<img src="images/icon_popup.gif" border="0">&nbsp;<a href="http://www.worldpay.com" style="text-decoration: underline; font-weight: bold;">Visita la web de WorldPay</a>');
