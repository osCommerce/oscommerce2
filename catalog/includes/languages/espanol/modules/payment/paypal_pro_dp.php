...
*/
  ...
  define('MODULE_PAYMENT_PAYPAL_PRO_DP_CARD_VALID_FROM', 'Tarjeta valida desde:');
  define('MODULE_PAYMENT_PAYPAL_PRO_DP_CARD_VALID_FROM_INFO', '(si est&aacute; disponible)');
  define('MODULE_PAYMENT_PAYPAL_PRO_DP_CARD_EXPIRES', 'Fecha de caducidad:');
  define('MODULE_PAYMENT_PAYPAL_PRO_DP_CARD_CVC', 'C&oacute;digo de seguridad:');
  define('MODULE_PAYMENT_PAYPAL_PRO_DP_CARD_ISSUE_NUMBER', 'Issue n&uacute;mero de tarjeta:');
  define('MODULE_PAYMENT_PAYPAL_PRO_DP_CARD_ISSUE_NUMBER_INFO', '(es solo para tarjeta de Maestro y Solo)');
  define('MODULE_PAYMENT_PAYPAL_PRO_DP_ERROR_ALL_FIELDS_REQUIRED', 'Error: Todos los datos son obligatorios.');
?>
