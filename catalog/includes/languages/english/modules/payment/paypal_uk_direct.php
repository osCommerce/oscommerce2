...
*/
  ...
  define('MODULE_PAYMENT_PAYPAL_UK_DIRECT_CARD_OWNER_FIRSTNAME', 'Card Owner First Name:');
  define('MODULE_PAYMENT_PAYPAL_UK_DIRECT_CARD_OWNER_LASTNAME', 'Card Owner Last Name:');
