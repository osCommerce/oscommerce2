...
define('HEADING_TITLE_ADDRESS_BOOK', 'My Personal Address Book');
...
define('ADDRESS_BOOK_ENTRY', 'Address Book Entry');
...
define('SUCCESS_TEXT_ACCOUNT_CREATED', 'Congratulations! Your new account has been successfully created! You can now take advantage of member priviledges to enhance your online shopping experience with us. If you have <small><strong>ANY</strong></small> questions about the operation of this online shop, please email the <a href="' . tep_href_link('info', 'contact') . '">store owner</a>.<br /><br />A confirmation has been sent to the provided email address. If you have not received it within the hour, please <a href="' . tep_href_link('info', 'contact') . '">contact us</a>.');
