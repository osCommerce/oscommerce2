...
define('BOOTSTRAP_DATEPICKER_I18N_CODE', ''); // leave empty for en_US; see http://bootstrap-datepicker.readthedocs.org/en/release/options.html#language
define('BOOTSTRAP_DATEPICKER_FORMAT', 'mm/dd/yyyy'); // see http://bootstrap-datepicker.readthedocs.org/en/release/options.html#format
