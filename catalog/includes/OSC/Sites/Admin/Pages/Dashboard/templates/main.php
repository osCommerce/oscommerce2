    ...
    for ( $i=0, $n=sizeof($adm_array); $i<$n; $i++ ) {
      ...
      if (strpos($adm, '\\') !== false) {
        ...
        if ( !class_exists($class) ) {
          include(DIR_FS_ADMIN . 'includes/languages/' . $language . '/modules/dashboard/' . $adm);
          include(DIR_FS_ADMIN . 'includes/modules/dashboard/' . $class . '.php');
        }
      }
...
<?php
  require(DIR_FS_ADMIN . 'includes/template_bottom.php');
?>
