...
// the following cPath references come from application_top.php
  ...
  require(OSCOM::BASE_DIR . 'languages/' . $_SESSION['language'] . '/index.php');
...
<?php include(OSCOM::BASE_DIR . 'modules/new_products.php'); ?>
...
// optional Product List Filter
    ...
    include(OSCOM::BASE_DIR . 'modules/product_listing.php');
?>
...
<?php
    ...
    include(OSCOM::BASE_DIR . 'modules/new_products.php');
    include(OSCOM::BASE_DIR . 'modules/upcoming_products.php');
?>
