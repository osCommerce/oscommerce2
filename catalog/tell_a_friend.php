...
*/
  ...
  if ($valid_product == false) {
    osc_redirect(osc_href_link(FILENAME_PRODUCT_INFO, 'products_id=' . (int)$_GET['products_id']));
  }
  ...
  if (isset($_GET['action']) && ($_GET['action'] == 'process') && isset($_POST['formid']) && ($_POST['formid'] == $_SESSION['sessiontoken'])) {
    ...
    if ($error == false) {
      ...
      $email_body .= sprintf(TEXT_EMAIL_LINK, osc_href_link(FILENAME_PRODUCT_INFO, 'products_id=' . (int)$_GET['products_id'], 'NONSSL', false)) . "\n\n" .
  ...
  $breadcrumb->add(NAVBAR_TITLE, osc_href_link(FILENAME_TELL_A_FRIEND, 'products_id=' . (int)$_GET['products_id']));
...
<?php echo osc_draw_form('email_friend', osc_href_link(FILENAME_TELL_A_FRIEND, 'action=process&products_id=' . (int)$_GET['products_id']), 'post', 'class="form-horizontal" role="form"', true); ?>
...
<div class="contentContainer">
  ...
  <div class="contentText">
    <div class="form-group has-feedback">
      ...
      <div class="col-xs-9">
        <?php
        echo osc_draw_input_field('from_name', NULL, 'required aria-required="true" id="inputFromName" placeholder="' . FORM_FIELD_CUSTOMER_NAME . '"');
    ...
    <div class="form-group has-feedback">
      ...
      <div class="col-xs-9">
        <?php
        echo osc_draw_input_field('from_email_address', NULL, 'required aria-required="true" id="inputFromEmail" placeholder="' . FORM_FIELD_CUSTOMER_EMAIL . '"', 'email');
        echo FORM_REQUIRED_INPUT;
        ?>
      </div>
    </div>
  ...
  <div class="contentText">
    <div class="form-group has-feedback">
      ...
      <div class="col-xs-9">
        <?php
        echo osc_draw_input_field('to_name', NULL, 'required aria-required="true" id="inputToName" placeholder="' . FORM_FIELD_FRIEND_NAME . '"');
        echo FORM_REQUIRED_INPUT;
        ?>
      </div>
    </div>
    <div class="form-group has-feedback">
      ...
      <div class="col-xs-9">
        <?php
        echo osc_draw_input_field('to_email_address', NULL, 'required aria-required="true" id="inputToEmail" placeholder="' . FORM_FIELD_FRIEND_EMAIL . '"', 'email');
        echo FORM_REQUIRED_INPUT;
        ?>
      </div>
    </div>
  ...
  <div class="contentText">
    <div class="form-group has-feedback">
      ...
      <div class="col-xs-9">
        <?php
        echo osc_draw_textarea_field('message', 'soft', 40, 8, NULL, 'required aria-required="true" id="inputMessage" placeholder="' . FORM_TITLE_FRIEND_MESSAGE . '"');
        echo FORM_REQUIRED_INPUT;
        ?>
      </div>
    </div>
  ...
  <div class="row">
    ...
    <div class="col-sm-6"><?php echo osc_draw_button(IMAGE_BUTTON_BACK, 'glyphicon glyphicon-chevron-left', osc_href_link(FILENAME_PRODUCT_INFO, 'products_id=' . (int)$_GET['products_id'])); ?></div>
  </div>
</div>
