...
*/
  ...
  $breadcrumb->add(NAVBAR_TITLE, osc_href_link(FILENAME_SPECIALS));
...
?>
      ...
      <div class="col-sm-6">
        <div class="well well-sm">
           <div class="row">
              <div class="col-xs-3 col-md-3 text-center"><?php echo '<a href="' . osc_href_link(FILENAME_PRODUCT_INFO, 'products_id=' . $specials['products_id']) . '">' . osc_image(DIR_WS_IMAGES . $specials['products_image'], $specials['products_name'], SMALL_IMAGE_WIDTH, SMALL_IMAGE_HEIGHT) . '</a>'; ?></div>
              <div class="col-xs-9 col-md-9 info-box">
                <h4><?php echo '<a href="' . osc_href_link(FILENAME_PRODUCT_INFO, 'products_id=' . $specials['products_id']) . '">' . $specials['products_name'] . '</a>'; ?></h4>
                <hr />
                <div class="row">
                  <div class="col-sm-6">
                  ...
                  <div class="col-sm-6 text-right">
                    <?php echo osc_draw_button(IMAGE_BUTTON_IN_CART, 'glyphicon glyphicon-shopping-cart', osc_href_link(FILENAME_PRODUCTS_NEW, osc_get_all_get_params(array('action')) . 'action=buy_now&products_id=' . $specials['products_id']), null, null, 'btn-success'); ?>
                  </div>
                </div>
             </div>
          </div>
