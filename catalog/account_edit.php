...
// reset the session variables
  ...
  $breadcrumb->add(NAVBAR_TITLE_2, osc_href_link(FILENAME_ACCOUNT_EDIT, '', 'SSL'));
...
<?php echo osc_draw_form('account_edit', osc_href_link(FILENAME_ACCOUNT_EDIT, '', 'SSL'), 'post', 'class="form-horizontal" role="form"', true) . osc_draw_hidden_field('action', 'process'); ?>
...
?>
      ...
      <div class="form-group has-feedback">
        ...
        <div class="col-xs-9">
          <?php echo osc_draw_input_field('firstname', $account['customers_firstname'], 'required aria-required="true" id="inputFirstName" placeholder="' . ENTRY_FIRST_NAME . '"'); ?>
          <?php echo FORM_REQUIRED_INPUT; ?>
      ...
      <div class="form-group has-feedback">
        ...
        <div class="col-xs-9">
          <?php echo osc_draw_input_field('lastname', $account['customers_lastname'], 'required aria-required="true" id="inputLastName" placeholder="' . ENTRY_LAST_NAME . '"'); ?>
          <?php echo FORM_REQUIRED_INPUT; ?>
...
?>
      ...
      <div class="form-group has-feedback">
        ...
        <div class="col-xs-9">
          <?php echo osc_draw_input_field('dob', osc_date_short($account['customers_dob']), 'required aria-required="true" id="dob" placeholder="' . ENTRY_DATE_OF_BIRTH_TEXT . '"'); ?>
          <?php echo FORM_REQUIRED_INPUT; ?>
...
?>
    ...
    <div class="form-group has-feedback">
      ...
      <div class="col-xs-9">
        <?php echo osc_draw_input_field('email_address', $account['customers_email_address'], 'required aria-required="true" id="inputEmail" placeholder="' . ENTRY_EMAIL_ADDRESS . '"', 'email'); ?>
        <?php echo FORM_REQUIRED_INPUT; ?>
    ...
    <div class="form-group has-feedback">
      ...
      <div class="col-xs-9">
        <?php echo osc_draw_input_field('telephone', $account['customers_telephone'], 'required aria-required="true" id="inputTelephone" placeholder="' . ENTRY_TELEPHONE_NUMBER . '"'); ?>
        <?php echo FORM_REQUIRED_INPUT; ?>
    ...
    <div class="form-group">
      ...
      <div class="col-xs-9">
        <?php echo osc_draw_input_field('fax', $account['customers_fax'], 'id="inputFax" placeholder="' . ENTRY_FAX_NUMBER . '"'); ?>
