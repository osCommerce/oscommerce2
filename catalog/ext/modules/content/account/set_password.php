...
// needs to be included earlier to set the success message in the messageStack
  ...
  $breadcrumb->add(MODULE_CONTENT_ACCOUNT_SET_PASSWORD_NAVBAR_TITLE_1, osc_href_link(FILENAME_ACCOUNT, '', 'SSL'));
  $breadcrumb->add(MODULE_CONTENT_ACCOUNT_SET_PASSWORD_NAVBAR_TITLE_2, osc_href_link('ext/modules/content/account/set_password.php', '', 'SSL'));
...
<?php echo osc_draw_form('account_password', osc_href_link('ext/modules/content/account/set_password.php', '', 'SSL'), 'post', 'class="form-horizontal" role="form"', true) . osc_draw_hidden_field('action', 'process'); ?>
...
<div class="contentContainer">
  ...
  <div class="contentText">
    <div class="form-group has-feedback">
      ...
      <div class="col-xs-9">
        <?php
        echo osc_draw_password_field('password_new', NULL, 'required aria-required="true" id="inputPassword" placeholder="' . ENTRY_PASSWORD_NEW . '"');
    ...
    <div class="form-group has-feedback">
      ...
      <div class="col-xs-9">
        <?php
        echo osc_draw_password_field('password_confirmation', NULL, 'required aria-required="true" id="inputConfirmation" placeholder="' . ENTRY_PASSWORD_CONFIRMATION . '"');
        echo FORM_REQUIRED_INPUT;
