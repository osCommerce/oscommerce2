...
*/
  ...
  if ( isset($_GET['action']) ) {
    ...
    osc_redirect(osc_href_link('ext/modules/content/account/braintree/cards.php', '', 'SSL'));
  }

  $breadcrumb->add(MODULE_CONTENT_ACCOUNT_BRAINTREE_CARDS_NAVBAR_TITLE_1, osc_href_link(FILENAME_ACCOUNT, '', 'SSL'));
  $breadcrumb->add(MODULE_CONTENT_ACCOUNT_BRAINTREE_CARDS_NAVBAR_TITLE_2, osc_href_link('ext/modules/content/account/braintree/cards.php', '', 'SSL'));
...
?>
    ...
    <div>
      <span style="float: right;"><?php echo osc_draw_button(SMALL_IMAGE_BUTTON_DELETE, 'glyphicon glyphicon-trash', osc_href_link('ext/modules/content/account/braintree/cards.php', 'action=delete&id=' . (int)$tokens['id'] . '&formid=' . md5($_SESSION['sessiontoken']), 'SSL')); ?></span>
