...
INSERT INTO categories_description VALUES ( '12', '2', 'Komˆdie');
...
INSERT INTO languages VALUES (3,'EspaÒol','es','icon.gif','espanol',3);
...
INSERT INTO products_description VALUES (1,2,'Matrox G200 MMS','<b>Unterst¸tzung f¸r zwei bzw. vier analoge oder digitale Monitore</b><br><br>\r\nDie Matrox G200 Multi-Monitor-Serie f¸hrt die bew‰hrte Matrox Tradition im Multi-Monitor- Bereich fort und bietet flexible und fortschrittliche Lˆsungen.Matrox stellt als erstes Unternehmen einen vierfachen digitalen PanelLinkÆ DVI Flachbildschirm Ausgang zur Verf¸gung. Mit den optional erh‰ltlichen TV Tuner und Video-Capture Mˆglichkeiten stellt die Matrox G200 MMS eine alles umfassende Mehrschirm-Lˆsung dar.<br><br>\r\n<b>Leistungsmerkmale:</b>\r\n<ul>\r\n<li>Preisgekrˆnter Matrox G200 128-Bit Grafikchip</li>\r\n<li>Schneller 8 MB SGRAM-Speicher pro Kanal</li>\r\n<li>Integrierter, leistungsstarker 250 MHz RAMDAC</li>\r\n<li>Unterst¸tzung f¸r bis zu 16 Bildschirme ¸ber 4 Quad-Karten (unter Win NT,ab Treiber 4.40)</li>\r\n<li>Unterst¸tzung von 9 Monitoren unter Win 98</li>\r\n<li>2 bzw. 4 analoge oder digitale Ausgabekan‰le pro PCI-Karte</li>\r\n<li>Desktop-Darstellung von 1800 x 1440 oder 1920 x 1200 pro Chip</li>\r\n<li>Anschluﬂmˆglichkeit an einen 15-poligen VGA-Monitor oder an einen 30-poligen digitalen DVI-Flachbildschirm plus integriertem Composite-Video-Eingang (bei der TV-Version)</li>\r\n<li>PCI Grafikkarte, kurze Baul‰nge</li>\r\n<li>Treiberunterst¸tzung: WindowsÆ 2000, Windows NTÆ und WindowsÆ 98</li>\r\n<li>Anwendungsbereiche: Bˆrsenumgebung mit zeitgleich groﬂem Visualisierungsbedarf, Video¸berwachung, Video-Conferencing</li>\r\n</ul>','www.matrox.com/mga/deutsch/products/g200_mms/home.cfm',0);
INSERT INTO products_description VALUES (2,2,'Matrox G400 32 MB','<b>Neu! Matrox G400 &quot;all inclusive&quot; und vieles mehr...</b><br><br>\r\nDie neue Millennium G400-Serie - Hochleistungsgrafik mit dem sensationellen Unterschied. Ausgestattet mit dem neu eingef¸hrten Matrox G400 Grafikchip, bietet die Millennium G400-Serie eine ¸berragende Beschleunigung inklusive bisher nie dagewesener Bildqualitat und enorm flexibler Darstellungsoptionen bei allen Ihren 3D-, 2D- und DVD-Anwendungen.<br><br>\r\n<ul>\r\n<li>DualHead Display und TV-Ausgang</li>\r\n<li>Environment Mapped Bump Mapping</li>\r\n<li>Matrox G400 256-Bit DualBus</li>\r\n<li>3D Rendering Array Prozessor</li>\r\n<li>Vibrant Color Quality≤ (VCQ≤)</li>\r\n<li>UltraSharp DAC</li>\r\n</ul>\r\n<i>&quot;Bleibt abschlieﬂend festzustellen, daﬂ die Matrox Millennium G400 Max als Allroundkarte f¸r den Highend-PC derzeit unerreicht ist. Das ergibt den Testsieg und unsere w‰rmste Empfehlung.&quot;</i><br>\r\n<b>GameStar 8/99 (S.184)</b>','www.matrox.com/mga/deutsch/products/mill_g400/home.cfm',0);
INSERT INTO products_description VALUES (3,2,'Microsoft IntelliMouse Pro','Die IntelliMouse Pro hat mit der IntelliRad-Technologie einen neuen Standard gesetzt. Anwenderfreundliche Handhabung und produktiveres Arbeiten am PC zeichnen die IntelliMouse aus. Die gewˆlbte Oberseite paﬂt sich nat¸rlich in die Handfl‰che ein, die geschwungene Form erleichtert das Bedienen der Maus. Sie ist sowohl f¸r Rechts- wie auch f¸r Linksh‰nder geeignet. Mit dem Rad der IntelliMouse kann der Anwender einfach und komfortabel durch Dokumente navigieren.<br><br>\r\n<b>Eigenschaften:</b>\r\n<ul>\r\n<li><b>ANSCHLUSS:</b> PS/2</li>\r\n<li><b>FARBE:</b> weiﬂ</li>\r\n<li><b>TECHNIK:</b> Mauskugel</li>\r\n<li><b>TASTEN:</b> 3 (incl. Scrollrad)</li>\r\n<li><b>SCROLLRAD:</b> Ja</li>\r\n</ul>','',0);
INSERT INTO products_description VALUES (4,2,'Die Ersatzkiller','Originaltitel: &quot;The Replacement Killers&quot;<br><br>\r\nRegional Code: 2 (Japan, Europe, Middle East, South Africa).<br>\r\nSprachen: English, Deutsch.<br>\r\nUntertitel: English, Deutsch, Spanish.<br>\r\nAudio: Dolby Surround 5.1.<br>\r\nBildformat: 16:9 Wide-Screen.<br>\r\nDauer: (approx) 80 minutes.<br>\r\nAuﬂerdem: Interaktive Menus, Kapitelauswahl, Untertitel.<br><br>\r\n(USA 1998). Til Schweiger schieﬂt auf Hongkong-Star Chow Yun-Fat (&quot;Anna und der Kˆnig&quot;) ≠ ein Fehler ...','www.replacement-killers.com',0);
INSERT INTO products_description VALUES (5,2,'Blade Runner - Director\'s Cut','Regional Code: 2 (Japan, Europe, Middle East, South Africa).<br>\r\nSprachen: English, Deutsch.<br>\r\nUntertitel: English, Deutsch, Spanish.<br>\r\nAudio: Dolby Surround 5.1.<br>\r\nBildformat: 16:9 Wide-Screen.<br>\r\nDauer: (approx) 112 minutes.<br>\r\nAuﬂerdem: Interaktive Menus, Kapitelauswahl, Untertitel.<br><br>\r\n<b>Sci-Fi-Klassiker, USA 1983, 112 Min.</b><br><br>\r\nLos Angeles ist im Jahr 2019 ein Hexenkessel. Dauerregen und Smog tauchen den ¸berbevˆlkerten Moloch in ewige D‰mmerung. Polizeigleiter schwirren durch die Luft und ¸berwachen das grelle Ethnogemisch, das sich am Fuﬂe 400stˆckiger Stahlbeton-Pyramiden tummelt. Der abgehalfterte Ex-Cop und \"Blade Runner\" Rick Deckard ist Spezialist f¸r die Beseitigung von Replikanten, k¸nstlichen Menschen, geschaffen f¸r harte Arbeit auf fremden Planeten. Nur ihm kann es gelingen, vier fl¸chtige, hochintelligente \"Nexus 6\"-Spezialmodelle zu stellen. Die sind mit ihrem starken und brandgef‰hrlichen Anf¸hrer Batty auf der Suche nach ihrem Schˆpfer. Er soll ihnen eine l‰ngere Lebenszeit schenken. Das muﬂ Rick Deckard verhindern.  Als sich der eiskalte J‰ger in Rachel, die Sekret‰rin seines Auftraggebers, verliebt, ger‰t sein Weltbild jedoch ins Wanken. Er entdeckt, daﬂ sie - vielleicht wie er selbst - ein Replikant ist ...<br><br>\r\nDie Konfrontation des Menschen mit \"Realit‰t\" und \"Virtualit‰t\" und das verstrickte Spiel mit get¸rkten Erinnerungen zieht sich als roter Faden durch das Werk von Autor Philip K. Dick (\"Die totale Erinnerung\"). Sein Roman \"Tr‰umen Roboter von elektrischen Schafen?\" liefert die Vorlage f¸r diesen doppelbˆdigen Thriller, der den Zuschauer mit faszinierenden\r\nZukunftsvisionen und der gigantischen Kulisse des Groﬂstadtmolochs gefangen nimmt.','www.bladerunner.com',0);
...
INSERT INTO products_options VALUES (2,2,'Grˆﬂe');
...
# Spain
INSERT INTO zones (zone_country_id, zone_code, zone_name) VALUES (195,'A CoruÒa','A CoruÒa');
