...
?>
  ...
  <div class="contentText">
    ...
    <div class="form-group has-feedback">
      ...
      <div class="col-sm-9">
        <?php
        echo HTML::textareaField('review', 'soft', 60, 15, NULL, 'minlength="' . REVIEW_TEXT_MIN_LENGTH . '" required aria-required="true" id="inputReview" placeholder="' . ENTRY_REVIEW_TEXT . '"');
